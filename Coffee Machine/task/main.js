...
// I have added sugar to the supplies

let exitStatus = false;
let supplies = {water: 400, milk: 540, beans: 120, sugar: 200, cups: 9, money: 550};
const nameOfSupplies = {water: 'water', milk: 'milk', beans: 'coffee beans', sugar: 'sugar', cups: 'disposable cups', money: 'money'};
const coffee = {espresso: {water: 250, milk: 0, beans: 16, sugar: 0, cups: 1, money: -4},
  latte: {water: 350, milk: 75, beans: 20, sugar: 15, cups: 1, money: -7},
  cappuccino: {water: 200, milk: 100, beans: 12, sugar: 25, cups: 1, money: -6}};
...
function writeStatus() {
  ...
  console.log(`${supplies.sugar} g of sugar`);
...
function fill() {
  ...
  console.log("Write how many grams of sugar do you want to add:");
  supplies.sugar += Number(input());
